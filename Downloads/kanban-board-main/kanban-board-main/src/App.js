...
function App() {
  ...
  const priorityLabels = {
    ...
    2:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/low.jpg"} className='user-pic' alt="Low" />  Low
      </div>
    ),
    3:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/medium.jpg"} className='user-pic' alt="Medium" />  Medium
      </div>
    ), 
    4:(
      <div className="user-label">
      <img src={process.env.PUBLIC_URL + "/high.jpg"}  className='user-pic' alt="High" />  High
      </div>
    ),  
    1:(
      <div className="user-label">
